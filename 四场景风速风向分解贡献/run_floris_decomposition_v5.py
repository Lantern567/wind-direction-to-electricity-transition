...
# 相对路径定位（满足 git clone 后直接可跑）
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
REPO = os.path.dirname(SCRIPT_DIR)  # repo root
...
# 验证关键输入文件存在
for _f, _label in [(V5_CSV, 'v5 AEP CSV'), (S3_CSV, 'S3 comparison'), (S1_CSV, 'S1 optimal orientation')]:
