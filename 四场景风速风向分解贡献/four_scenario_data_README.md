...
生成日期：2026-08-04（v3 修正版：ERA5 去重 + 电气损耗 + 全量 1,153 场-年）
...
| 文件 | 行数 | 说明 |
|------|------|------|
| `four_scenario_aep_farmyear.csv` | 1,153 | 每场-年四情景 AEP（P00/P10/P01/P11）及无尾流 AEP |
| `four_scenario_effects_farmyear.csv` | 1,153 | 每场-年风速主效应 S、风向主效应 D、交互 I、Shapley 贡献、朝向收益 gain_pct |
| `four_scenario_farm_summary.csv` | 171 | 风场级汇总：G、M_S、M_D、R_i（106 场 ≥5 年） |
| `four_scenario_threshold_farms.csv` | 171 | 带越线标记（106 场 ≥5 年进入主统计） |
| `four_scenario_decomposition.py` | — | 主计算脚本（含 ERA5 去重 + 电气损耗修正） |
